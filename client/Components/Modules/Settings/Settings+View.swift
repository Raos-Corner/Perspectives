...
public struct GraniteWebView: NSViewRepresentable {
    ...
    public class Coordinator: NSObject, WKScriptMessageHandler, WKUIDelegate, WKNavigationDelegate {
        var parent: GraniteWebView

        init(_ parent: GraniteWebView) {
            self.parent = parent
        }
